...
class ResponseServiceTest {
    ...
    void setUp() {
        ...
        responseService = new IResponseService(responseRepository);
    }
    ...
    void testHasResponded() {
        ...
        boolean result = responseService.hasResponded(bookId, responderId);

        assertTrue(result, "The user should have responded to the poll");
    ...
    void testSaveResponse() {
        ...
        responseService.saveResponse(choice, user);
    ...
    void testSaveResponses() {
        ...
        responseService.saveResponses(choices, user);
    ...
    void testGetPollResults() {
        ...
        Map<String, Long> results = responseService.getPollResults(bookId);
    ...
    void testDeleteResponsesWithPollId() {
        ...
        responseService.deleteResponsesWithPollId(bookId);
